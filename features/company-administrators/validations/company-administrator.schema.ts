 ...
 *
 * Password and status are intentionally excluded.
 * Password reset and account status use separate APIs.
 */
export const companyAdministratorEditSchema = z.object({
    firstName: z
        .string()
        .trim()
        .min(2, "First name must contain at least 2 characters.")
...
export type CompanyAdministratorEditFormInput =
    z.input<typeof companyAdministratorEditSchema>;

export type CompanyAdministratorEditFormValues =
    z.output<typeof companyAdministratorEditSchema>;